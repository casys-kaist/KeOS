...
#[stdin(b"KeOS is fun!")]
pub fn mm_mmap_error_bad_addr() {
    assert_eq!(run_elf("mm_mmap_error_bad_addr"), 0);
}

#[stdin(b"")]
#[assert_output(b"success ")]
pub fn mm_mmap_error_bad_fd() {
    run_elf("mm_mmap_error_bad_fd");
}
...
#[stdin(b"")]
#[assert_output(b"success ")]
pub fn mm_munmap_error_bad_addr() {
    run_elf("mm_munmap_error_bad_addr");
}

#[stdin(b"")]
#[assert_output(b"success ")]
pub fn mm_munmap_error_double_free() {
    run_elf("mm_munmap_error_double_free");
}

#[stdin(b"")]
#[assert_output(b"success ")]
pub fn mm_munmap_error_unaligned() {
    run_elf("mm_munmap_error_unaligned");
}
